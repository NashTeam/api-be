...
loghandler = {
    notparam: {
        ...
        getApikey: 'Apikey??? Hubungi OWNER'
    },
    notkey: {
        status: false,
        creator: `${creator}`,
    ...
    notkata: {
        ...
        creator: `${creator}`,
        code: 406,
        message: 'Masukkan parameter kata..!'
    },
    nottext: {
        status: false,
        creator: `${creator}`,
    ...
    notnabi: {
        ...
        creator: `${creator}`,
        code: 406,
        message: 'Masukkan parameter nabi..!'
    },
    nottext3: {
        status: false,
        creator: `${creator}`,
        code: 406,
        message: 'Masukkan parameter text3..!'
    },
    nottheme: {
        status: false,
        creator: `${creator}`,
        code: 406,
        message: 'Masukkan parameter theme..!'
    },
    notusername: {
        status: false,
        creator: `${creator}`,
    ...
    notvalue: {
        ...
        creator: `${creator}`,
        code: 406,
        message: 'Masukkan parameter value..!'
    },
    notheme: {
    	status: false,
        creator: `${creator}`,
    ...
    notAddApiKey: {
        ...
        creator: `${creator}`,
        code: 406,
        message: 'Masukkan parameter status, apikeyInput, email, nomorhp, name, age, country, exp'
    },
    error: {
        status: false,
        creator: `${creator}`,
...
const listkey = ["BERKAHESPORT", "@moexti"];
...
var len = 15
        ...
        var randomTextNumber = random+randomlagi+'---------moextiGanteng'+'Moe--GANS';
...
router.get('/addapikey', (req, res, next) => {
    ...
    if (apikey != 'berkahesport') return res.json(loghandler.invalidKey)
...
router.get('/infonpm', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'berkahesport') return res.json(loghandler.invalidKey)
    if (!query) return res.json({ status : false, creator : `${creator}`, message : "Masukkan parameter query"})
...
router.get('/base', async (req, res, next) => {
	var type = req.query.type,
		...
		if (!apikeyInput) return res.json(loghandler.notparam)
		if (apikeyInput != 'berkahesport') return res.json(loghandler.invalidKey)
		if (!type) return res.json({status: false, creator, code: 404, message: 'Masukkan parameter type, type yang tersedia : base64 , base32'})
...
router.get('/hadits', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'berkahesport') return res.json(loghandler.invalidKey)
    if (!kitab) return res.json({ status : false, creator : `${creator}`, message : "Masukkan parameter kitab"})
    if (!nomor) return res.json({ status : false, creator : `${creator}`, message : "Masukkan parameter nomor"})
...
router.get('/quran', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'berkahesport') return res.json(loghandler.invalidKey)
    if (!surah) return res.json({ status : false, creator : `${creator}`, message : "Masukkan parameter surah"})
    if (!ayat) return res.json({ status : false, creator : `${creator}`, message : "Masukkan parameter ayat"})
...
router.get('/drakorasia', async (req, res, next) => {
	...
	if(apikeyInput != 'berkahesport') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`http://docs-api-moextir.herokuapp.com/api/drakorasia?search=${search}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/infocuaca/bandara', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'berkahesport') return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://bmkg-api-moexti.herokuapp.com/api/cuaca/bandara`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/infocuaca/dunia', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'berkahesport') return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://bmkg-api-moexti.herokuapp.com/api/cuaca/dunia`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/infotsunami', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'berkahesport') return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://bmkg-api-moexti.herokuapp.com/api/tsunami`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/quotes/kanye', async (req, res, next) => {
	...
	if(apikeyInput != 'berkahesport') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://docs-api-moextir.herokuapp.com/api/quote?type=kanye`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/translate', async (req, res, next) => {
	...
	if(apikeyInput != 'berkahesport') return res.json(loghandler.invalidKey)
	if(!kata) return res.json({ status : false, creator : `${creator}`, message : "Masukkan parameter kata"})
       fetch(encodeURI(`https://docs-api-moextir.herokuapp.com/api/translate?text=${kata}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/anime/kusonime', async (req, res, next) => {
	...
	if(apikeyInput != 'berkahesport') return res.json(loghandler.invalidKey)
	if(!search) return res.json({ status : false, creator : `${creator}`, message : "Masukkan parameter search"})
       fetch(encodeURI(`https://docs-api-moextir.herokuapp.com/api/kusonime?search=${search}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/gabut', async (req, res, next) => {
	...
	if(apikeyInput != 'berkahesport') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://docs-api-moextir.herokuapp.com/api/bosan`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/manga', async (req, res, next) => {
	...
	if(apikeyInput != 'berkahesport') return res.json(loghandler.invalidKey)
	if(!search) return res.json({ status : false, creator : `${creator}`, message : "Masukkan parameter search"})
       fetch(encodeURI(`https://docs-api-moextir.herokuapp.com/api/manga?keyword=${search}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/random/wallpaper', async (req, res, next) => {
	...
	if(apikeyInput != 'berkahesport') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://docs-api-moextir.herokuapp.com/api/random/wallpaper?genre=acak`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/news/cnn', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'berkahesport') return res.json(loghandler.invalidKey)
    if (!type) return res.json({ status : false, creator : `${creator}`, message : "Masukkan parameter type"})
...
router.get('/filmapik/search', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'berkahesport') return res.json(loghandler.invalidKey)
    if (!film) return res.json({ status : false, creator : `${creator}`, message : "Masukkan parameter film"})

       fetch(encodeURI(`https://filmapik-api-moexti.herokuapp.com/search?q=${film}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/filmapik/kategori', async (req, res, next) => {
    ...
    if (!film) return res.json({ status : false, creator : `${creator}`, message : "Masukkan parameter film"})
       ...
       fetch(encodeURI(`https://filmapik-api-moexti.herokuapp.com/category?search=${film}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/filmapik/play', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'berkahesport') return res.json(loghandler.invalidKey)
    if (!id) return res.json({ status : false, creator : `${creator}`, message : "Masukkan parameter id"})

       fetch(encodeURI(`https://filmapik-api-moexti.herokuapp.com/play?id=${id}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/filmapik/terbaru', async (req, res, next) => {
	...
	if(apikeyInput != 'berkahesport') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://filmapik-api-moexti.herokuapp.com/latest`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/lk21/search', async (req, res, next) => {
    ...
    if (!film) return res.json({ status : false, creator : `${creator}`, message : "Masukkan parameter film"})
       ...
       fetch(encodeURI(`https://lk21-api-moexti.herokuapp.com/search?query=${film}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/lk21/terbaru', async (req, res, next) => {
	...
	if(apikeyInput != 'berkahesport') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://lk21-api-moexti.herokuapp.com/newupload`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/lk21/comingsoon', async (req, res, next) => {
	...
	if(apikeyInput != 'berkahesport') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://lk21-api-moexti.herokuapp.com/comingsoon`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/lk21/tvseries', async (req, res, next) => {
	...
	if(apikeyInput != 'berkahesport') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://lk21-api-moexti.herokuapp.com/tv`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/lk21/year', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'berkahesport') return res.json(loghandler.invalidKey)
    if (!tahun) return res.json({ status : false, creator : `${creator}`, message : "Masukkan parameter tahun"})

       fetch(encodeURI(`https://lk21-api-moexti.herokuapp.com/year?year=${tahun}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/lk21/country', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'berkahesport') return res.json(loghandler.invalidKey)
    if (!negara) return res.json({ status : false, creator : `${creator}`, message : "Masukkan parameter negara"})

       fetch(encodeURI(`https://lk21-api-moexti.herokuapp.com/country?country=${negara}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/lk21/genre', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'berkahesport') return res.json(loghandler.invalidKey)
    if (!tipe) return res.json({ status : false, creator : `${creator}`, message : "Masukkan parameter tipe"})

       fetch(encodeURI(`https://lk21-api-moexti.herokuapp.com/genre?genre=${tipe}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/ig/stalk', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'berkahesport') return res.json(loghandler.invalidKey)
    if (!username) return res.json({ status : false, creator : `${creator}`, message : "Masukkan parameter username"})
...
router.get('/maker', async (req, res, next) => {
    ...
    if (!text) return res.json({ status : false, creator : `${creator}`, message : "Masukkan parameter text"})
       ...
       fetch(encodeURI(`https://textmaker-api-moexti.herokuapp.com/api/textmaker?text=${text}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/maker2', async (req, res, next) => {
    ...
    if (!text) return res.json({ status : false, creator : `${creator}`, message : "Masukkan parameter text"})
       ...
       fetch(encodeURI(`https://textmaker-api-moexti.herokuapp.com/api/textmaker2?text=${text}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/repository/stalk', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'berkahesport') return res.json(loghandler.invalidKey)
    if (!username) return res.json({ status : false, creator : `${creator}`, message : "Masukkan nama repository yang ingin kamu cari"})
...
router.get('/maker3', async (req, res, next) => {
    ...
    if (!text) return res.json({ status : false, creator : `${creator}`, message : "Masukkan parameter text"})
       ...
       fetch(encodeURI(`https://textmaker-api-moexti.herokuapp.com/api/textmaker3?text=${text}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/maker4', async (req, res, next) => {
    ...
    if (!text) return res.json({ status : false, creator : `${creator}`, message : "Masukkan parameter text"})
       ...
       fetch(encodeURI(`https://textmaker-api-moexti.herokuapp.com/api/textmaker4?text=${text}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/maker3d', async (req, res, next) => {
    ...
    if (!text) return res.json({ status : false, creator : `${creator}`, message : "Masukkan parameter text"})
       ...
       fetch(encodeURI(`https://textmaker-api-moexti.herokuapp.com/api/text3d?text=${text}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/maker3d/no2', async (req, res, next) => {
    ...
    if (!text) return res.json({ status : false, creator : `${creator}`, message : "Masukkan parameter text"})
       ...
       fetch(encodeURI(`https://textmaker-api-moexti.herokuapp.com/api/text3d-2?text=${text}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/maker3d/no3', async (req, res, next) => {
    ...
    if (!text) return res.json({ status : false, creator : `${creator}`, message : "Masukkan parameter text"})
       ...
       fetch(encodeURI(`https://textmaker-api-moexti.herokuapp.com/api/text3d-3?text=${text}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/maker3d/no4', async (req, res, next) => {
    ...
    if (!text) return res.json({ status : false, creator : `${creator}`, message : "Masukkan parameter text"})
       ...
       fetch(encodeURI(`https://textmaker-api-moexti.herokuapp.com/api/text3d-4?text=${text}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/yutub/search', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'berkahesport') return res.json(loghandler.invalidKey)
    if (!video) return res.json({ status : false, creator : `${creator}`, message : "Masukkan parameter video"})
...
router.get('/maker/special/transformer', async (req, res, next) => {
    ...
    if (!text) return res.json({ status : false, creator : `${creator}`, message : "Masukkan parameter text"})
       ...
       fetch(encodeURI(`https://textmaker-api-moexti.herokuapp.com/api/special/transformer?text=${text}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/maker/special/epep', async (req, res, next) => {
    ...
    if (!text) return res.json({ status : false, creator : `${creator}`, message : "Masukkan parameter text"})
       ...
       fetch(encodeURI(`https://textmaker-api-moexti.herokuapp.com/api/special/sertifikatepep?text=${text}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
